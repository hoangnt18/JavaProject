...
// 	
		...
		//Infor's account
		inforPanel.setLocation(370, 300);
...
//		question.setOpaque(true);
		...
		topicQuestion.setFont(new java.awt.Font("Airal", 1,30));
		...
		String questionText = "Ấn button trả lời để tiếp tục chơi !!!";
		
		JScrollPane scroll = new JScrollPane (topicQuestion);
		topicQuestion.setText(questionText);
		scroll.setFont(new java.awt.Font("Airal", 1,30));
		scroll.setBounds(5, 50, 520, 180);

		
		childTopPanel.add(question);
		childTopPanel.add(scroll);
...
//		StackAndQuence sandQ = new StackAndQuence();
		...
		ArrayList<String>  questionJava = mySQL.OutStreamQuestionGetMySQL();  /////////// doi code
//		sandQ.QuestionArr();
		String [] questionArr =  new String[questionJava.size()] ;
		

		ArrayList<String>  anwserJava = mySQL.OutStreamAnwserGetMySQL() ; /////////doi code
...
//		fr.add(backgroundHeo);
	...
	private void topicQuestion(int verticalScrollbarAlways) {
		// TODO Auto-generated method stub
