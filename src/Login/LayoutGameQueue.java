...
public class LayoutGameQueue {
public void LayoutGameQueue() throws IOException {
	...
	JTextField nameTF,scoreTF;
	 ...
	 nameTF.setBounds(150,10,500,30);
...
//	Part of bottom Pannel
	...
	ArrayList<String>  questionJava = sandQ.OutStreamQuestionGet();  /////////// doi code
//	sandQ.QuestionArr();
	String [] questionArr =  new String[questionJava.size()] ;
	

	ArrayList<String>  anwserJava = sandQ.OutStreamAnwserGet() ; /////////doi code
